...
export const Profile = () => {
  ...
  return (
    <div
      className="w-screen mx-auto bg-black sm:w-11/12 md:w-10/12 lg:w-9/12 xl:w-8/12"
      style={{ overflowY: "scroll" }}
    >
      <div
        className="w-full mx-auto mt-10 text-white md:w-3/5 md:mr-auto md:ml-0"
        onClick={() => setclick(true)}
      >
        <div className="pb-6 bg-black">
          {fectuser() && (
            <SkeletonTheme baseColor="#202020" highlightColor="#444">
              <div className="w-full max-w-sm p-4 mx-auto space-y-4 text-white bg-black rounded-lg shadow-md">
